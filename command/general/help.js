...
• ${prefix}yuri
• ${prefix}megumin
• ${prefix}waifu\n\n*IND:* kirim !help diikuti dengan nama perintah untuk mendapatkan perintah detail, example !help sticker\n\n*EN:* send ${prefix}help followed by a command name to get detail of command, e.g. ${prefix}help sticker`
